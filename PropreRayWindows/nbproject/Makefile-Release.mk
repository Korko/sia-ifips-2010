...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/MinGW-Windows/propreraywindows.exe

dist/Release/MinGW-Windows/propreraywindows.exe: ${OBJECTFILES}
...
${OBJECTDIR}/Matrice4D.o: nbproject/Makefile-${CND_CONF}.mk Matrice4D.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Matrice4D.o Matrice4D.cpp

${OBJECTDIR}/Point4D.o: nbproject/Makefile-${CND_CONF}.mk Point4D.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Point4D.o Point4D.cpp
...
${OBJECTDIR}/Vecteur4D.o: nbproject/Makefile-${CND_CONF}.mk Vecteur4D.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Vecteur4D.o Vecteur4D.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/MinGW-Windows/propreraywindows.exe
